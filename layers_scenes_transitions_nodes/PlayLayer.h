...
namespace gd
{
    ...
    public:
        ...
        void onCheck(CCObject* pSender)
        {
            reinterpret_cast<void(__thiscall*)(UILayer*, CCObject*)>(
                base + 0x25fb60)(this, pSender);
        }

        void onDeleteCheck(CCObject* pSender)
        {
            reinterpret_cast<void(__thiscall*)(UILayer*, CCObject*)>(
                base + 0x25fc90)(this, pSender);
        }

        void onPause(CCObject* pSender)
        {
            reinterpret_cast<void(__thiscall*)(UILayer*, CCObject*)>(
                base + 0x25fad0)(this, pSender);
        }
    };

    class GDH_DLL StartPosObject : public EffectGameObject
    {
    public:
    ...
    public:
        ...
        void resetLevel()
        {
            reinterpret_cast<void(__thiscall*)(PlayLayer*)>(
                base + 0x20BF00)(this);
        }

        float timeForXPos(float xpos)
        {
            return reinterpret_cast<float(__thiscall*)(PlayLayer*, float)>(
                base + 0x2087D0)(this, xpos);
        }

        void playerWillSwitchMode(gd::PlayerObject* player, gd::GameObject* id)
        {
            reinterpret_cast<void(__thiscall*)(PlayLayer*, gd::PlayerObject*, gd::GameObject*)>(
                base + 0x209540)(this, player, id);
        }

        void switchToFlyMode(gd::PlayerObject* player, gd::GameObject* param2, bool param3, int param4)
        {
            reinterpret_cast<void(__thiscall*)(PlayLayer*, gd::PlayerObject*, gd::GameObject*, bool, int)>(
                base + 0x2097C0)(this, player, param2, param3, param4);
        }

        void togglePracticeMode(bool on)
        {
            reinterpret_cast<void(__thiscall*)(PlayLayer*, bool)>(
                base + 0x20d0d0)(this, on);
        }
        ...
        void pauseGame(bool unk)
        {
            reinterpret_cast<void(__thiscall*)(PlayLayer*, bool)>(gd::base + 0x20d3c0)(this, unk);
        }
    };
}
